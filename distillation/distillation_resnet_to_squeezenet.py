...
if __name__ == "__main__":
    ...
    TEACHER_MODEL_CHECKPOINTS = "/home/ray/nfs/autolang_storage/projects/divyam/primary_ft_training/resnet50_full/final_model.pt"
    # STUDENT_MODEL_NAME = "mobilenet_v2"
    TEMPERATURE = 1
    ALPHA = 0.5
    NUM_CLASSES = 525
    NUM_DISTILLATION_EPOCHS = 30
    FINAL_CHECKPOINT_DIR = "/home/ray/nfs/autolang_storage/projects/divyam/distillation_training/resnet50-_to_squeezenet_non_pretrained/"
